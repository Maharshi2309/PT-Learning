...
import 'package:myapp/Service/resetpass_service.dart' as _i947;
...
extension GetItInjectableX on _i174.GetIt {
  ...
  _i174.GetIt init({
    ...
    gh.singleton<_i947.ResetpassService>(() => _i947.ResetpassService());
    gh.singleton<_i72.LoginBloc>(
      () => _i72.LoginBloc(gh<_i1006.AuthService>()),
    );
    gh.singleton<_i378.ResetpassBloc>(
      () => _i378.ResetpassBloc(gh<_i947.ResetpassService>()),
    );
