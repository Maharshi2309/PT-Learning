  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<ForgorPassBloc, ForgotPassState>(
      listener: (context, state) {
        ...
        if (state.status == ForgotStatus.errorForgot) {
      ...
      child: BlocBuilder<ForgorPassBloc, ForgotPassState>(
        builder: (context, state) {
          switch (state.status) {
            ...
            case ForgotStatus.processForgot:
              return Scaffold(
                backgroundColor: Colors.white,
                body: const Center(child: CircularProgressIndicator()),
              );
            case ForgotStatus.doneForgot:
              return SizedBox(child: Text('Email Sent Successfully'));
            case ForgotStatus.errorForgot:
              return Scaffold(
                body: Center(
                  child: Column(
